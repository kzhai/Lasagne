...
def rademacher_p_2_q_2(network, rescale=False, **kwargs):
...
def rademacher_p_inf_q_1(network, rescale=False, **kwargs):
    input_layer = find_input_layer(network)
...
def rademacher_p_1_q_inf(network, rescale=False, **kwargs):
    input_layer = find_input_layer(network)
