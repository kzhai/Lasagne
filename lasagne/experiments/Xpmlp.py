...
def validate_pmlp_arguments(arguments):
...
def train_pmlp():
	...
	settings = config_model(construct_pmlp_parser, validate_pmlp_arguments)
	settings = validate_config(settings)

	network = networks.PrunableMultiLayerPerceptron(
