...
class StandoutNeuralNetworkTypeA(FeedForwardNetwork):
	...
	def build_functions(self):
		...
		trainable_inadaptable_params_updates = self._update_function(train_loss, trainable_inadaptable_params,
		...
		trainable_adaptable_params_updates = self._update_function(snn_train_loss, trainable_adaptable_params,
		                                                           self._learning_rate_variable, momentum=0.95)
