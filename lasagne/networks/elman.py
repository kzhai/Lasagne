...
# from lasagne.Xnetworks import RecurrentNetwork, AdaptiveRecurrentNetwork
from lasagne import init, nonlinearities, objectives, updates, networks
from lasagne import layers

logger = logging.getLogger(__name__)

__all__ = [
	"ElmanNetworkFromSpecifications",
	"DynamicElmanNetwork"
]


# class ElmanNetwork(RecurrentNetwork):
def ElmanNetworkFromSpecifications(
		input_layer,
	...
	neural_network = layers.EmbeddingLayer(neural_network,
...
# from networks import AdaptiveRecurrentNetwork
class DynamicElmanNetwork(networks.AdaptiveRecurrentNetwork):
	def __init__(self,
	             sequence_length,
