...
class ObstructedDenseLayer(Layer):
    def __init__(self, incoming, num_units, obstructed_incoming, num_obstructed_units, W=init.GlorotUniform(), b=init.Constant(0.),
...
class DynamicPrunableDenseLayer(AdaptableDenseLayer):
    def __init__(self, incoming, num_units, W=init.GlorotUniform(),
                 b=init.Constant(0.), nonlinearity=nonlinearities.rectify,
                 num_leading_axes=1, **kwargs):
        super(DynamicPrunableDenseLayer, self).__init__(incoming, num_units, W, b, nonlinearity, num_leading_axes,
                                                        **kwargs)
...
class DynamicDenseLayerGuo(AdaptableDenseLayer):
    def __init__(self, incoming, num_units, W=init.GlorotUniform(),
                 b=init.Constant(0.), nonlinearity=nonlinearities.rectify,
                 num_leading_axes=1, **kwargs):
        super(DynamicDenseLayerGuo, self).__init__(incoming, num_units, W, b, nonlinearity,
                                                   num_leading_axes,
                                                   **kwargs)
...
class WeightPruningDenseLayer(DynamicPrunableDenseLayer):
    def __init__(self, incoming, num_units, W=init.GlorotUniform(),
                 b=init.Constant(0.), nonlinearity=nonlinearities.rectify,
                 num_leading_axes=1, **kwargs):
